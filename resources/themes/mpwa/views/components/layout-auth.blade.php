...
<head>
    ...
    <link rel="icon"
        href="https://static.vecteezy.com/system/resources/thumbnails/027/510/023/small_2x/cat-adventures-journeys-with-a-curious-explorer-ai-generative-png.png"
        type="image/png" />
    ...
    <link
        href="{{ asset('assets/css/bootstrap.' . (in_array(app()->getLocale(), ['ar', 'he', 'fa']) ? 'rtl' : 'ltr') . '.min.css') }}"
        rel="stylesheet" />
    <link href="{{ asset('assets/css/bootstrap-extended.css') }}" rel="stylesheet" />
    <link
        href="{{ asset('assets/css/style.' . (in_array(app()->getLocale(), ['ar', 'he', 'fa']) ? 'rtl' : 'ltr') . '.css') }}"
        rel="stylesheet" />
